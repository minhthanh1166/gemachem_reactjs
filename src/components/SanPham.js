...
import hn1 from '../img/sanpham/hn-1.jpg'
import hn2 from '../img/sanpham/hn-2.jpg'
import hc1 from '../img/sanpham/hc-1.png'
import hc3 from '../img/sanpham/hc-3.png'
import hc4 from '../img/sanpham/hc-4.png'
import { useNavigate } from 'react-router-dom'
function SanPham() {
  const navigate = useNavigate();
  const handleHC = () => navigate("/sanpham2");
  return (
    <div>
      <div id="product">
  <div className="container">
    ...
    <div className="content_">
      <div className="title-rela">
        <h2 className="h1-2b">
          <a href="#" title="Hóa Chất">
            Hóa Chất
          </a>
        </h2>
        <a href="#" className="see-all" onClick={handleHC}>
          Xem tất cả <i className="fa fa-angle-right" aria-hidden="true" />
        </a>
      </div>
      <ul className="list-product_">
        <li>
          <div className="item">
            <a href="#" className="avt" title="Sodium Nitrate">
              <img src={hc3} alt="Sodium Nitrate" />
            </a>
            <h3>
        ...
        <li>
          <div className="item">
            <a href="#" className="avt" title="Potassium Chlorate">
              <img src={hc1} alt="Potassium Chlorate" />
            </a>
            <h3>
    ...
    <div className="side-bar_">
      <div className="box">
        <h2 className="h2-sb">Sản phẩm</h2>
      ...
      <div className="box">
        ...
        <ul className="list-hot-news">
          ...
          <li>
            ...
            <h3 className="h3-hn">
              <a href="#" title="4 cảnh báo cho nhà đầu tư shophouse">
